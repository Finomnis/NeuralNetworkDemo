...
SmallestFullNetwork::SmallestFullNetwork()
{
    ...
    layers.emplace_back(std::make_unique<LinearLayer>(1, 15, 0.1));
    layers.emplace_back(std::make_unique<ReluLayer>(15));
    layers.emplace_back(std::make_unique<LinearLayer>(15, 1, 0.1));
